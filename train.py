...
def main(args=None):
    ...
    if paddle.is_compiled_with_cuda():
        ...
        retinanet = paddle.DataParallel(retinanet)
    ...
    for epoch_num in range(parser.epochs):
        ...
        for iter_num, data in enumerate(dataloader_train):
            try:
                ...
                paddle.nn.ClipGradByNorm_(retinanet.parameters(), 0.1)
        ...
        paddle.save(retinanet.module, '{}_retinanet_{}.pt'.format(parser.dataset, epoch_num))

    retinanet.eval()

    paddle.save(retinanet, 'model_final.pt')
